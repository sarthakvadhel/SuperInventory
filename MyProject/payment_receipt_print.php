                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            ...
                                            <td width="95%" align="left" valign="top"><br />
                                                ...
                                                // Fetch customer details based on the customer's name
                                                $customerDetails = $db->queryUniqueObject("SELECT * FROM customer_details WHERE customer_name='$line->customer' ");

                                                // Check if $customerDetails is not null before accessing its properties
                                                if ($customerDetails) {
                                                    echo $customerDetails->customer_address;
                                                    ?>
                                                    <br />
                                                    <?php
                                                    echo "Contact1: " . $customerDetails->customer_contact1 . "<br>";
                                                    echo "Contact2: " . $customerDetails->customer_contact2 . "<br>";
                                                } else {
                                                    echo "Customer details not found for Name: $line->customer";
                                                }
                                                ?></td>
                                        </tr>
                                    </table>
...
<?php
        ...
        echo "Error in processing printing the Payment receipt";
    }
}
?>
