...
<head>
  ...
  <!-- jQuery & JS files  important -->
	...
	<script>
function getCustomerSuggestions(value) {
    // Make an AJAX request to fetch customer suggestions
    var xhr = new XMLHttpRequest();
    xhr.onreadystatechange = function() {
        if (xhr.readyState == 4 && xhr.status == 200) {
            // Update the suggestions div with the response
            document.getElementById("customerSuggestions").innerHTML = xhr.responseText;
        }
    };
    xhr.open("GET", "get_customer_suggestions.php?value=" + value, true);
    xhr.send();
}
</script>
		<script>
...
<tr></tr>
  <tr align="center">
    <td style="width: 154.453px;"><strong>By Customer Name</strong></td>

    <td style="width: 300px;">
        <input type="text" name="customer" id="customer" class="round default-width-input" placeholder="Select Customer name" list="customerList">
	...
	<td style="width: 100px;"><input name="submit" type="button" value="Show" onClick='sales_report_name_fn();'></td>
</tr>
<tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
