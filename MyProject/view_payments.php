...
?>	
							...
							<?php
                                    ...
                                    $SQL = "SELECT DISTINCT(transactionid), due FROM  stock_sales WHERE balance > 0";

                                    if (isset($_POST['Search']) && trim($_POST['searchtxt']) != "") {
                                        $SQL = "SELECT DISTINCT(transactionid), due FROM  stock_sales WHERE stock_name LIKE '%" . $_POST['searchtxt'] . "%' OR supplier_name LIKE '%" . $_POST['searchtxt'] . "%' OR transactionid  LIKE '%" . $_POST['searchtxt'] . "%' OR date LIKE '%" . $_POST['searchtxt'] . "%' AND balance>0";
                                    }
