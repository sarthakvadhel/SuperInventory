...
{ 
    var selectedProductName = $('#product_purchase').val(); // Fix the product name
   var selectedSupplierName = $('#supplier_name').val();
 window.open("complete_purchase_report.php?start_date="+$('#start_date_purchase').val()+"&end_date="+$('#end_date_purchase').val()+"&product_name="+encodeURIComponent(selectedProductName) +"&supplier_name="+ encodeURIComponent(selectedSupplierName),"myNewWinsr","width=620,height=800,toolbar=0,menubar=no,status=no,resizable=yes,location=no,directories=no,scrollbars=yes"); 
}
 ...
 <table   border="0" cellspacing="0" cellpadding="0">
  ...
  <form action="" method="post"  name="purchase_report" id="purchase_report" target="myNewWinsr">
    <tr>
              ...
              <select name="supplier_name" id="supplier_name"  maxlength="200"     >
