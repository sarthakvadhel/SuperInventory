 ...
 <table   border="0" cellspacing="0" cellpadding="0">
     ...
     <tr>
      ...
      <form action="" method="post" name="search" >
         <tr>
                     <td style="width: 154.453px;" ><strong>By Product Name</strong></td>
                    ...
                    <td style="width: 100px;"><input name="submit" type="button" value="Show" onClick='sales_report_product_fn();'></td>
          </tr>
          </form>	
