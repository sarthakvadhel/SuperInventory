...
<p align="center"> Software Developed By: <strong>Sarthak Vadhel</strong> </br>
www.sarthakvadhel.engineer &nbsp; E-mail : svadhel245@rku.ac.in</p>
</footer>
</html>
<?php
}
else
echo "Please select from and to date to process report";
}
?>