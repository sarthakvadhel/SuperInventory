...
<head>
	<meta charset="utf-8">
	<title>Super Inventory - Login to Control Panel</title>
...
<?php include_once("analyticstracking.php") ?>
	...
	<div id="header">
		...
		<div class="page-full-width cf">
			...
			<a href="#" id="company-branding" class="fr"><img src="<?php if(isset($_SESSION['logo'])) { echo "upload/".$_SESSION['logo'];}else{ echo "upload/default.png"; } ?>" alt="Point of Sale" /></a>
