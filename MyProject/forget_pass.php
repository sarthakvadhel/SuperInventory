...
<?php include_once("analyticstracking.php") ?>
	...
	<div id="header">
		...
		<div class="page-full-width cf">
			...
			<a href="#" id="company-branding" class="fr"><img src="<?php if(isset($_SESSION['logo'])) { echo "upload/".$_SESSION['logo'];}else{ echo "upload/default.png"; } ?>" alt="Super Inventory" /></a>
...
<input type="submit" name="submit" value="Submit" class="button round blue image-right ic-right-arrow" style="align-item:center;">
 <a href="index.php" class="button blue round side-content" style="align-item:center;">Back</a>
</form>
		</fieldset>
    <?php }?>
...
<script type="text/javascript">
    ...
    </script><p> &copy;Copyright hold by Sarthak Vadhel</p>
